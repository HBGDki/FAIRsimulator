...
myMultStud <- runMultiSim(StudyObjIni,iter=iter,ncores=ncores,cohortAgeNames=c("6-12 months","12-18 months"),strProb="UnWeightedRandomizationProbabilities")
```
...
trtNams1 <- c("SoC-1","Cell 1", "Cell 2","Cell 3","Cell 4")
...
for(i in 1:length(myMultStud[[1]])) {
  myList[[i]] <- myMultStud[[1]][[i]]$FinalAnalysesList[[1]]$UnWeightedUpdateProbabilities
}
```
